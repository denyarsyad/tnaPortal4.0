<div class="container-fluid">
	<h1 class="h3 mb-3 text-gray-800 font-weight-bold">Dashboard Supervisor Maintenance</h1>
				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="h3 mb-0 font-weight-bold"><?= $jml_new_spvm ?></div>
				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="h3 mb-0 font-weight-bold"><?= $jml_ticket_spvm?></div>
						</div>
						<div class="col-auto">
				...
				<div class="card-body">
					<div class="table-responsive">
						<table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
							...
							<tbody>
								<?php $no = 1;
								foreach ($ticket_spvm as $row) { ?>
									<tr>
										<td><?= $no ?></td>
										<td><a href="<?= site_url('ticket_spvm/set_prioritas/'.$row->id_ticket)?>" title="Detail Tiket <?= $row->id_ticket; ?>" class="font-weight-bold"><?= $row->id_ticket ?></a></td>
										<td><?= $row->tanggal ?></td>
										<td><?= $row->nama ?></td>
										...
										<td>
											<?php if ($row->status == 9) { ?>
												<a href="<?= site_url('ticket_spvm/pending/' . $row->id_ticket) ?>" class="btn btn-warning text-dark btn-circle btn-sm pending" title="Pending">
