...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			<form method="post" action="<?= site_url('ticket_mgrd/submit') ?>" enctype="multipart/form-data">
    ...
    <input type="date" class="form-control" <?= (form_error('due_date') ? 'is-invalid' : '') ?>" name="due_date" placeholder="Due date" value="<?= set_value('due_date'); ?>" required>
    <p class="small mb-6">contoh: 20-05-2025</p>
    <div class="invalid-feedback">
        <?= form_error('due_date'); ?>
    </div>
</div>
