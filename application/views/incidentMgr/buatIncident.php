...
<div class="container-fluid">
	...
	<p class="mb-3">Kirim Data Ticket.</p>

	<div class="flash-data" data-flashdata="<?= $this->session->flashdata('status') ?>"></div>

	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Form Pengajuan Ticket <?= $dd_dept ?></h6>
		</div>
		<div class="card-body">
			<form method="post" action="<?= site_url('incident_mgr/submit') ?>" enctype="multipart/form-data">
