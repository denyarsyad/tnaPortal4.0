...
<div class="container-fluid">
	<!-- <div class="d-sm-flex align-items-center justify-content-between">
		...
		<a href="<?= site_url('ticket_teknisi/change_category/' . $detail['id_incident']) ?>" class="btn btn-warning text-dark btn-icon-split change">
						...
						<div class="col-md-4">
							...
							<div class="card">
								<div class="card-body">
									...
									<hr>
									<h6 class="m-0 text-primary">Departemen - Sub Depatemen</h6>
									<div class="font-weight-bold">
										<?= $detail['nama_dept'] ?><br>
									</div>
									<hr>
									...
									<hr>
									<h6 class="m-0 text-primary">Approved By</h6>
									<div class="font-weight-bold">
										<?= $detail['id_action'] . " - " . $detail['date_action'] ?><br>
									</div>
									<hr>
								</div>
							</div>
							...
							<div class="accordion mb-3" id="accordionReply">
								<div class="card">
									...
									<div id="collapseOne" class="collapse <?= (form_error('message') ? "show" : "") ?>" aria-labelledby="headingOne" data-parent="#accordionReply">
										<div class="card-body">
											<form action="<?= site_url('ticket_teknisi/submitMessage/' . $detail['id_incident']) ?>" method="post" enctype="multipart/form-data">
												<div class="form-group">
