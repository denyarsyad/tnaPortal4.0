...
<script>
	$(document).ready(function(){
		...
		const baseUrl = "<?= site_url('ticket_spvm/approve/' . $detail['id_ticket']) ?>";
		...
		<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
			<div class="card shadow mb-4">
				<div class="card-body">
					...
					<form id="myForm" method="post" action="<?= site_url('ticket_spvm/approve/' . $detail['id_ticket']) ?>" enctype="multipart/form-data">
						...
						<button type="button" class="btn btn-danger" onclick="window.location='<?= site_url('ticket_spvm/list_tugas_spvm') ?>'">Batal</button>
					</form>
				</div>
			</div>
		</div>
