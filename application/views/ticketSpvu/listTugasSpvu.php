		...
		<div class="col-xl-12 col-lg-12">
			<div class="card shadow mb-4">
				<div class="card-header font-weight-bold text-primary d-flex justify-content-between">
					...
					<a href="<?= site_url('ticket_spvu/export_excel'); ?>" 
				...
				<div class="card-body">
					<div class="table-responsive">
						<table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
							...
							<tbody>
								<?php $no = 1;
								foreach ($tugasSpvu as $row) { ?>
									<tr>
										<td><?= $no ?></td>
										<td><a href="<?= site_url('ticket_spvu/detail_approve_spvu/'.$row->id_ticket)?>" title="Detail Tiket <?= $row->id_ticket; ?>" class="font-weight-bold"><?= $row->id_ticket ?></a></td>
										<td><?= $row->tanggal ?></td>
										<td><?= $row->nama ?></td>
