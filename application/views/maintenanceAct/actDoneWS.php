...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			<form method="post" action="<?= site_url('maintenance_act/doneWS/'.$mtcID.'/'.$mtcName) ?>" enctype="multipart/form-data">
				...
				<button type="submit" class="btn btn-success btn-lg mr-2"><i class="fas fa-check"></i> Done With Spare Part</button>
