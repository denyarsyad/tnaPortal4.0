		...
		<div class="card-body">
			<form method="post" action="<?= site_url('maintenance_act/submit/'.$maintenanceAct['wo_id']) ?>" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-sm-4" >
						<div class="form-group">
							<label class="mb-1 font-weight-bold">Check By</label>
							<input type="text" class="form-control <?= (form_error('checker_name') ? 'is-invalid' : '') ?>" name="checker_name" value="<?= $maintenanceAct['checker_name'] ?>"  readonly>
							<div class="invalid-feedback">
								<?= form_error('checker_name'); ?>
							</div>
						</div>
					</div>
					<div class="col-sm-4" >
						<div class="form-group">
							<label class="mb-1 font-weight-bold">Check Date</label>
							<input type="date" class="form-control <?= (form_error('checker_date') ? 'is-invalid' : '') ?>" name="checker_date" value="<?= $maintenanceAct['checker_date'] ?>" readonly>
							<div class="invalid-feedback">
								<?= form_error('checker_date'); ?>
							</div>
						</div>
					</div>
					<div class="col-sm-4" >
						<div class="form-group">
							<label class="mb-1 font-weight-bold">Check Time</label>
							<input type="time" class="form-control <?= (form_error('checker_time') ? 'is-invalid' : '') ?>" name="checker_time" value="<?= $maintenanceAct['checker_time'] ?>"  readonly>
							<div class="invalid-feedback">
								<?= form_error('checker_time'); ?>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select id="note" class="form-control" name="note">
								...
								<option value="C">Tidak, pindah mesin</option>
							</select>
						</div>
					</div>
				</div>
