<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			<form action="<?= site_url('rental_spv/process/' . $vehicle['id_req']) ?>" method="post">
				<div class="form-group">
					...
					<div class="row mb-3 align-items-center">
						...
						<div class="col-md-6">
							<?php if (in_array($vehicle['status'], ["5", "6"])) { ?>
				...
				<?php if (in_array($vehicle['status'], ["1"])) { ?>
					...
					<div class="form-group" style="margin-top: 15px;">
						...
						<textarea name="spv_desc_input" placeholder="" class="form-control <?= (form_error('spv_desc_input') ? "is-invalid" : "") ?>" rows="6"><?= set_value('spv_desc_input'); ?></textarea>
						<div class="invalid-feedback">
							<?= form_error('spv_desc_input'); ?>
						</div>
					</div>	
				<?php } else { ?>
					...
					<div class="form-group">
						<label class="mb-1 font-weight-bold">PIC Note</label>
