...
class Ticket_spvu extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->session->userdata('level') == "SPVU") {
            //Menyusun template List Ticket
            $data['title']    = "Daftar Semua Tiket";
            $data['navbar']   = "navbar";
            $data['sidebar']  = "sidebar";
            $data['body']     = "ticket_spvu/allTicketSpvu";
    ...
    public function list_tugas_spvu()
    {
        //User harus SPVU, tidak boleh role user lain
        if ($this->session->userdata('level') == "SPVU") {
            ...
            $data['navbar']   = "navbar";
            $data['sidebar']  = "sidebar";
            $data['body']     = "ticketSpvu/listTugasSpvu";
            ...
            //Daftar semua tiket 
            $data['tugasSpvu'] = $this->model->list_ticket_spvu($id_user)->result();
    ...
    public function detail_approve_spvu($id)
    {
        //User harus SPVU, tidak boleh role user lain
        if ($this->session->userdata('level') == "SPVU") {
            ...
            $data['navbar']   = "navbar";
            $data['sidebar']  = "sidebar";
            $data['body']     = "ticketSpvu/detailApproveSpvu";
    ...
    public function set_prioritas($id)
    {
        if ($this->session->userdata('level') == "SPVU") {
            ...
            $data['navbar']   = "navbar";
            $data['sidebar']  = "sidebar";
            $data['body']     = "ticketSpvu/setprioritas";
    ...
    public function approve($id, $id_teknisi)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->session->userdata('level') == "SPVU") {
                ...
                $id_user = $this->session->userdata('id_user');
                $this->model->emailpenugasan($id, $id_user, $id_teknisi);
    ...
    {
        $listticket = $this->model->list_ticket_spvu()->result();
