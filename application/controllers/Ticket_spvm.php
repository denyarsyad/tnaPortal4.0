...
class Ticket_spvm extends CI_Controller
{
    ...
    {
        //User harus SPVM, tidak boleh role user lain
        if ($this->session->userdata('level') == "SPVM") {
            //Menyusun template List Ticket
            $data['title']    = "Daftar Semua Tiket";
            $data['navbar']   = "navbar";
            $data['sidebar']  = "sidebar";
            $data['body']     = "ticket_spvm/allTicketSpvm";
    ...
    public function list_tugas_spvm()
    {
        //User harus SPVM, tidak boleh role user lain
        if ($this->session->userdata('level') == "SPVM") {
            //Menyusun template List Approval Ticket
            $data['title']    = "Daftar Tiket";
            $data['desc']     = "Daftar Tiket Assign By Manager dan Assign To";
            $data['navbar']   = "navbar";
            $data['sidebar']  = "sidebar";
            $data['body']     = "ticketSpvm/listTugasSpvm";
            ...
            //Daftar semua tiket 
            $data['tugasSpvm'] = $this->model->list_ticket_spvm($id_user)->result();
            ...
            //Bagian ini jika role yang mengakses tidak sama dengan SPVU
            //Akan dibawa ke Controller Errorpage
            redirect('Errorpage');
        }
    }

    public function detail_approve_spvm($id)
    {
        //User harus SPVU, tidak boleh role user lain
        if ($this->session->userdata('level') == "SPVM") {
            //Menyusun template Detail Ticket yang belum di-approve
            $data['title']    = "Detail Tiket";
            $data['navbar']   = "navbar";
            $data['sidebar']  = "sidebar";
            $data['body']     = "ticketSpvm/detailApproveSpvm";
    ...
    public function set_prioritas($id)
    {
        if ($this->session->userdata('level') == "SPVM") {
            ...
            $data['navbar']   = "navbar";
            $data['sidebar']  = "sidebar";
            $data['body']     = "ticketSpvm/setprioritas";
    ...
    public function approve($id, $id_teknisi)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->session->userdata('level') == "SPVM") {
                ...
                //Memanggil fungsi kirim email dari SPVU ke user
                //$this->model->emailapprove($id);
                //Memanggil fungsi kirim email dari SPVU ke teknisi
                //$this->model->emailtugas($id);
                $id_user = $this->session->userdata('id_user');
                $this->model->emailpenugasan2($id, $id_user, $id_teknisi);
    ...
    */
    ...
    {
        $listticket = $this->model->list_ticket_spvm()->result();
