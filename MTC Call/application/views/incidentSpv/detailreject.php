<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-body">
			<form method="post" action="<?= site_url('incident_spv/reject/' . $detail['id_incident']) ?>" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label class="mb-1 font-weight-bold text-gray-800">No Incident</label>
				...
				<button type="button" class="btn btn-danger" onclick="window.location='<?= site_url('incident_spv') ?>'">Batal</button>
			</form>
		</div>
	</div>
</div>