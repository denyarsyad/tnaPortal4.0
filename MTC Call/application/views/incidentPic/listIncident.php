<div class="container-fluid">
	...
	<p class="mb-4">Daftar semua Incident yang sudah sudah di setujui.</p>
						...
						foreach ($ticket as $row) { ?>
							<tr>
								...
								<td>
									...
									<?php if ($row->status == "S") { ?>
									<a href="<?= site_url('incident_pic/pending/' . $row->id_incident) ?>" class="btn btn-warning btn-circle btn-sm" title="Pending">
