<div class="container-fluid">
	<h1 class="h3 mb-3 text-gray-800 font-weight-bold">Dashboard Manager <?= $dept ?></h1>
				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="h3 mb-0 font-weight-bold"><?= $jml_new_mgrd ?></div>
				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="h3 mb-0 font-weight-bold"><?= $jml_ticket_mgrd ?></div>
							<h4 class="small font-weight-bold">Ditolak: <span><?= $jml_reject_mgrd ?></span></h4>
						</div>
						<div class="col-auto">
						...
						<table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
							...
							<tbody>
								...
								foreach ($ticket_mgrd as $row) { ?>
									<tr>
										<td><?= $no ?></td>
										<td><a href="<?= site_url('ticket_mgrd/detail_approve/' . $row->id_ticket.'/'.$row->status) ?>" title="Detail Tiket <?= $row->id_ticket; ?>" class="font-weight-bold"><?= $row->id_ticket ?></a></td>
										<td><?= $row->tanggal ?></td>
										<td><?= $row->nama ?></td>
