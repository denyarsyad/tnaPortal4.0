        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card bg-light text-dark shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-uppercase mb-1">Semua Work Order Ditugaskan</div>
        ...
        <div class="col-xl-12 col-lg-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-gray-800">Work Order baru dan dalam proses (<?= $jmltugas ?>)</h6>
                </div>
                <div class="card-body">
