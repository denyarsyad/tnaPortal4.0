				...
				<div class="row">
					...
					<div class="col-sm-3" >
						<div class="form-group">
							...
							<input type="text" id="machine_id" class="form-control <?= (form_error('machine_id') ? 'is-invalid' : '') ?>" name="machine_id" value="<?= set_value('machine_id'); ?>" style="text-transform: uppercase;" oinput="this.value = this.value.toUpperCase();" require>
							<div class="invalid-feedback">
