			...
			<div class="card shadow mb-4">
				<div class="card-body">
					...
					<div class="form-group">
										<label class="mb-1 font-weight-bold text-gray-800">Note Manager Maintenance (return)</label>
										<textarea name="note" class="form-control" readonly rows="2"><?= $detail['mgr_noted'] ?></textarea>
									</div>
							...
							<div class="card" style="margin-top:5px;">
								<div class="card-header">
									...
									<span class="float-right">
										<?php if ($detail['status'] == 0 && strlen($detail['mgr_reject_id']) > 0) { ?>
												<?= $detail['last_update'] ?>
										<?php } else { ?>
												<?= $detail['mgr_date'] ?> 
										<?php	} ?>
								...
								<div class="card-body">
									<p class="card-text">
										<?php if ($detail['status'] == 0) { ?>
											<?= nl2br($detail['mgr_reject']) ?>
										<?php } else { ?>
											<?= nl2br($detail['mgr_noted']) ?>
										<?php	} ?>
									</p>
								</div>
							</div>
							<div class="card" style="margin-top:5px;">
								<div class="card-header">
									...
									<span class="font-weight-bold text-dark">
										<?php if ($detail['status'] == 0) { ?>
											<?= $detail['mgrd_reject_id'] ?>
										<?php } else { ?>
											<?= $detail['mgrd_id'] ?>
										<?php	} ?>	
									</span>
									<br />
										Dept <?= $detail['nama_dept'] ?>
									<span class="float-right">
										<?php if ($detail['status'] == 0 && strlen($detail['mgrd_reject_id']) > 0) { ?>
												<?= $detail['last_update'] ?>
										<?php } else { ?>
												<?= $detail['mgrd_date'] ?> 
										<?php	} ?>
								...
								<div class="card-body">
									<p class="card-text">
										<?php if ($detail['status'] == 0) { ?>
											<?= nl2br($detail['mgrd_reject']) ?>
										<?php } else { ?>
											<?= nl2br($detail['mgrd_noted']) ?>
										<?php	} ?>
									</p>
								</div>
							</div>
