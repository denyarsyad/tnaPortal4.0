<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-body">
			<form method="post" action="<?= site_url('ticket_user/noted/' . $detail['id_ticket']) ?>" enctype="multipart/form-data">
				<div class="form-group">
					<label class="mb-1 font-weight-bold text-gray-800">Penerima</label>
					<input class="form-control" name="reciepent" readonly value="<?= $detail['mgr_mail'] ?>">
				</div>
				...
				<div class="form-group">
					<label class="mb-1 font-weight-bold text-gray-800">Note</label>
					<textarea name="note" class="form-control" readonly rows="5"><?= $detail['mgr_noted'] ?></textarea>
				</div>
				...
				<div class="form-group">
					...
					<div class="alert alert-warning text-dark" role="alert">
						<p class="mb-0" style="font-size: 14px;">
							<i class="fas fa-exclamation-circle"></i> Masukkan alasan mengapa tiket ini akan di ajukan kembali.
						</p>
					</div>
