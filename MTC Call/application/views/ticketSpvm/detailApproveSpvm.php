					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							<div class="card" style="margin-top:5px;">
									<div class="card-header">
										<i class="fas fa-fw fa-user"></i> <span class="font-weight-bold text-dark"><?= $detail['mgr_id'] ?></span><br />
										Manager Maintenance
										<span class="float-right"><?= $detail['mgr_date'] ?></span>
									</div>
									<div class="card-body">
										<p class="card-text"><?= nl2br($detail['mgr_noted']) ?></p>
									</div>
								</div>

								<div class="card" style="margin-top:5px;">
									<div class="card-header">
										<i class="fas fa-fw fa-user"></i> <span class="font-weight-bold text-dark"><?= $detail['mgrd_id'] ?></span><br />
										Manager <?= $detail['nama_dept'] ?>
										<span class="float-right"><?= $detail['mgrd_date'] ?></span>
									</div>
									<div class="card-body">
										<p class="card-text"><?= nl2br($detail['mgrd_noted']) ?></p>
									</div>
								</div>
							<!-- -->
						</div>
