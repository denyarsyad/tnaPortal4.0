<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-body">
			<form method="post" action="<?= site_url('incident_mgr/reject/' . $detail['id_incident']) ?>" enctype="multipart/form-data">
				...
				<button type="button" class="btn btn-danger" onclick="window.location='<?= site_url('incident_mgr') ?>'">Batal</button>
			</form>
		</div>
	</div>
</div>