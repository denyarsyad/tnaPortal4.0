<div class="container-fluid">
	...
	<!-- Button Input -->
	<a href="<?= site_url('incident_mgr/buat') ?>" class="nav-link" style="padding-left: 0px;">
				...
				<table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
					...
					<tbody>
						...
						foreach ($ticket as $row) { ?>
							<tr>
								<td><?= $no ?></td>
								<td><a href="<?= site_url('incident_mgr/detail/' . $row->id_incident) ?>" class="font-weight-bold" title="Detail"><?= $row->id_incident ?></a></td>
								...
								<?php } ?>
								<td>
									<a href="<?= site_url('incident_mgr/detail/' . $row->id_incident) ?>" class="btn btn-primary btn-circle btn-sm" title="Detail">
