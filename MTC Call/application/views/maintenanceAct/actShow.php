		...
		<div class="card-body">
			<form method="post" action="<?= site_url('maintenance_act/action') ?>" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<textarea id="approver_message" class="form-control <?= (form_error('approver_message') ? 'is-invalid' : '') ?>" name="approver_message" readonly><?= $maintenanceAct['approver_message'] ?></textarea>
					<div class="invalid-feedback">
