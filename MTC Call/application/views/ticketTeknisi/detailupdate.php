		...
		<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
			<div class="card shadow mb-4">
				<div class="card-body">
					...
					<form method="post" <?php if ($detail['status'] == 13) { ?>  
											action="<?= site_url('ticket_teknisi/close_progress/' . $detail['id_ticket']) ?>" 
										<?php } else {?>
											action="<?= site_url('ticket_teknisi/update_progress/' . $detail['id_ticket']) ?>" 
...
<script type="text/javascript">
	...
	$('.change').on('click', function(e) {
		...
		Swal.fire({
			...
			text: "Work Order ini akan dikembalikan ke admin",
			icon: 'warning',
