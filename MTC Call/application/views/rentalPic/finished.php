<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			<form action="<?= site_url('rental_pic/finished/' . $vehicle['id_req']) ?>" method="post">
				<div class="form-group">
					...
					<div class="form-group">
						...
						<textarea name="pic_dreturn_desc" placeholder="" class="form-control <?= (form_error('pic_dreturn_desc') ? "is-invalid" : "") ?>" rows="6"><?= set_value('pic_dreturn_desc'); ?></textarea>
						<div class="invalid-feedback">
							<?= form_error('pic_dreturn_desc'); ?>
						</div>
					</div>

				</div>
				<br/>
					<button type="submit" class="btn btn-primary"><i class="fas fa-thumbs-up"></i> Finish</button>
					<a href="<?= site_url('rental_pic/giveBack/' . $vehicle['id_req']) ?>" class="btn btn-warning reject" title="Reject"><i class="fas fa-undo"></i> Give Back</a>
			</form>
		</div>
	</div>
</div>